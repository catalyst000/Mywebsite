...
const { ref: ref2, inView: inView2 } = useInView({ triggerOnce: true });
  return (
    <Box w="100%" h="fit=-content"  bg="transparent">
        <Navbar/>
            <Box 
        as="video"
        src="/bg-video.webm"
  ...
  />
  <Box ref={ref1} position="relative" mt="50px" justifyContent="space-between"  bg="transparent"  h="80%" display="flex" gap="5rem" flexDirection={{base: "column", md: "row"}} zIndex={1} p={4} color="white"  fontFamily="'Playfair Display', serif">
    <MotionBox  bg="transparent" w={{base: "100%", md: "600px"}} p={2}  h="fit-content"
     mb={{base:"2rem", md:""}}
...
<Link>
  ...
  >
    Book Us
        ...
        <Flex w="100%" h="fit-content" bg="transparent" mt={6} align="center" justify="space-even" gap={6}>
          {/* Twitter icon  */}
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" cursor="pointer" m="1rem" fill="currentColor">
...
>
  ...
  />
    ...
    {/* Whatsapp icon */}
   <svg viewBox="0 0 24 24" width="25" height="25" fill="currentColor" m="10rem" cursor="pointer">
...
{/* Github icon */}
 <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" cursor="pointer" _hover={{fill:"blue.300"}} 
     xmlns="http://www.w3.org/2000/svg">
...
>
  ...
  />
    ...
    <Box  bg="transparent" display="flex" alignItems="center" justifyContent="center" w={{base: "100%", md: "400px"}} h="fit-content" >
    <MotionBox   position="relative" bg="transparent" p="1rem" display="flex"
     alignItems="center" justifyContent="center"  borderRadius="300px"
      border="2px solid white" h="fit-content" w="fit-content"
    ...
    transition={{
      ...
      <Image src="/mypicture.webp" alt="Hero Image"   h="200%" w="250px" borderLeftBottomRadius="300px" borderRightBottomRadius="300px" borderRadius="300px" 
