      ...
      >
        {projects.map((project) => (
          ...
          >
            ...
            <Flex w="100%" h="30px" justify="space-between" align="center" bg="transparent" textAlign="center">
...
<Flex justify="space-between" align="center"   mt={2} w="100%" h="60px" bg="transparent">
